...
import {
  AtSign, Award, BarChart3, BookOpen, Bot, Brain, Briefcase, Camera,
  Clapperboard, Codepen, Cpu, Database, Dribbble, Dumbbell, Facebook,
  FileText, Gamepad2, Github, Gitlab, Globe, GraduationCap, Heart,
  Instagram, Link2, Mail, MapPin, MessageCircle, Mic, Music, PenLine,
  Phone, Rss, Send, Sparkles, Twitch, Twitter, Youtube,
} from "lucide-react";

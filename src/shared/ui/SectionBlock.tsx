...
export const SectionBlock = ({
  ...
  <section className={cn(className)}>
    ...
    <div aria-hidden="true" className="relative border-t border-line-strong">
    ...
    >
      <div>
        ...
        <h2 className="mt-1.5 font-serif text-[clamp(1.9rem,4vw,3.25rem)] font-semibold leading-[1.02] tracking-[-0.025em] text-ink">
          {title}
        </h2>
      </div>
      {href && (
        <Link
          to={href}
          className="group mb-2 flex items-center gap-1.5 border-b border-line-strong pb-0.5 font-mono text-[11px] uppercase tracking-[0.1em] text-muted transition-colors hover:border-signal hover:text-signal"
        >
          {linkText}
